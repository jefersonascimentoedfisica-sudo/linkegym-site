    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <p className="text-gray-600 mb-4">Passo {step} de 3</p>
          {error && (
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select name="residenceNeighborhood" value={formData.residenceNeighborhood} onChange={handleChange} required
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                      <option value="">Selecione um bairro...</option>
                      {GUARULHOS_NEIGHBORHOODS.map(n => <option key={n} value={n}>{n}</option>)}
                    </select>
                  </div>
                  <div>
            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea name="bio" value={formData.bio} onChange={handleChange} required rows={4}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600"
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="number" name="yearsExperience" value={formData.yearsExperience} onChange={handleChange} required min="0"
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600"
                      placeholder="10" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-3">
                    {SPECIALTIES_PT.map(spec => (
                      <button key={spec} type="button" onClick={() => handleSpecialtyToggle(spec)}
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  {GUARULHOS_NEIGHBORHOODS.map(neighborhood => (
                    <button key={neighborhood} type="button" onClick={() => handleNeighborhoodToggle(neighborhood)}
                      className={`p-3 rounded-lg border-2 font-medium transition text-left ${
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-sm text-blue-700">
                    <strong>Nota:</strong> Você poderá definir a prioridade de atendimento para cada bairro após o cadastro ser aprovado.
                  </p>
                </div>
              </div>
            )}
